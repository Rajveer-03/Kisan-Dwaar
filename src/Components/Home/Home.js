    ...
    return (
        <div className='Home'>
            ...
            <div className="home__nav">
                <h3><a href="" style={{ color: 'black' }}>Login</a></h3>
                <h3><a href="" style={{ color: 'black' }}>Register</a></h3>
            </div>


            <div id="header">
                <i class="fas fa-tractor fa-4x"></i>
                <h1>Welcome to Kisan Dwaar.</h1>
                <p>Kisan Dwaar – a one step solution for farmers
            ...
            <div id="main" style={{ backgroundColor: "#EF8172" }}>
                ...
                <header className="major container medium">
                    <h2 style={{ color: 'black' }}>Kisan Dwaar is a webapp through which farmers can sell crops to and buy
